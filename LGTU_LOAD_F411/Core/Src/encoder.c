...
uint16_t counter_encoder = 0; // переменная для хранения значений счетчика энкодера
uint8_t menu_item_disch = 1; // переменная для хранения значений пунктов меню экрана от 1 до 4
uint8_t menu_item_load = 1;
uint8_t menu_item = 1;
uint8_t type_item = 1;  // переменная для хранениея значения типов нагрузки
uint8_t mode_item = 1;   // переменная для хранениея значения типов режима
...
float32_t current_value = 0.0; 	// переменная для хранения значения тока настроенного энкодером
float32_t voltage_value = 0.0;	// переменная для хранения значения напряжения настроенного энкодером
float32_t power_value = 0.0;	// переменная для хранения значения мощности
